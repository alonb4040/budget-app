...
function parseScenarioExcel(arrayBuffer: ArrayBuffer): ParseResult {
  ...
  for (let i = headerRow + 1; i < rows.length; i++) {
    ...
    const NORMALIZE: Record<string, string> = {
      ...
      'תמי4/נספרסו': 'מנויים',
      'קוסמטיקה טיפולים': 'מוצרי קוסמטיקה ופארם',
      'קוסמטיקה מוצרים': 'מוצרי קוסמטיקה ופארם',
      'קוסמטיקה': 'מוצרי קוסמטיקה ופארם',
      'פארם': 'מוצרי קוסמטיקה ופארם',
      'מספרה': 'תספורת',
      'שמרטף': 'בייביסיטר',
      'סופר (אוכל)': 'סופר',
      'תרופות כרוניות': 'תרופות קבועות',
      'פסיכולוג/הוראה מתקנת': 'פסיכולוג',
      'מעון': 'מעון/צהרון',
      'צהרון': 'מעון/צהרון',
    };
    ...
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, flexWrap: "wrap", gap: 10 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
          ...
          {scenarios.length > 0 && !activeScenarioValid && (
            <Btn size="sm" variant="primary"
              style={{ background: "var(--red)", boxShadow: "0 4px 16px rgba(229,57,53,0.3)" }}
              onClick={() => setView("activate")}>
              ⚠️ יש לבחור תסריט פעיל!
            </Btn>
          )}
        </div>

...
export const CATEGORIES: Record<string, string[]> = {
  ...
  "דיור":           ["שכר דירה","משכנתה","חשמל","ארנונה","גז","מים וביוב","וועד בית","עוזרת בית","גינון"],
  "תקשורת":         ["טלפון נייד","טלפון קווי","ספק אינטרנט","תשתית אינטרנט","כבלים","עיתונים"],
  "ילדים":          ["מעון/צהרון","בי\"ס - תשלומים קבועים","חוגים","שיעורי עזר","קיץ גדול וחומרי לימוד","אוניברסיטה","דמי כיס","ספרים וצעצועים","בייביסיטר","מזונות"],
  ...
  "בריאות":         ["תרופות קבועות","טיפולי שיניים","פסיכולוג"],
  "רכב":            ["טיפולים ורישוי"],
  "פנאי קבוע":      ["מכון כושר"],
  "מנויים":         ["מנויים"],
  "חיסכון":         ["חסכונות"],
  "קניות ואוכל":    ["סופר","מוצרי קוסמטיקה ופארם","אוכל בחוץ (כולל משלוחים)","ארוחות צהריים (עבודה)","מוצרים לבית","טיטולים ומוצרים לתינוק","חיות מחמד","סיגריות"],
  "טיפוח ויופי":    ["תספורת","ביגוד והנעלה"],
  ...
  "שונות":          ["מזומן ללא מעקב","הוצאות לא מתוכננות"],
  "להתעלם":         ["להתעלם"],
};

// אייקונים לתצוגה בלבד — לא מאוחסנים ב-DB
